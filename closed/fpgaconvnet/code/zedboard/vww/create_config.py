...
net.partitions[0].graph.nodes["Conv_65"]["hw"].coarse_out  = pointwise_coarse_out//2
net.partitions[0].graph.nodes["Conv_73"]["hw"].coarse_out  = pointwise_coarse_out//2
net.partitions[0].graph.nodes["Conv_81"]["hw"].coarse_out  = pointwise_coarse_out
net.partitions[0].graph.nodes["Conv_89"]["hw"].coarse_out  = pointwise_coarse_out//2
net.partitions[0].graph.nodes["Conv_97"]["hw"].coarse_out  = pointwise_coarse_out
net.partitions[0].graph.nodes["Conv_105"]["hw"].coarse_out = pointwise_coarse_out//2
net.partitions[0].graph.nodes["Conv_113"]["hw"].coarse_out = pointwise_coarse_out
net.partitions[0].graph.nodes["Conv_121"]["hw"].coarse_out = pointwise_coarse_out
net.partitions[0].graph.nodes["Conv_129"]["hw"].coarse_out = pointwise_coarse_out
net.partitions[0].graph.nodes["Conv_137"]["hw"].coarse_out = pointwise_coarse_out
net.partitions[0].graph.nodes["Conv_145"]["hw"].coarse_out = pointwise_coarse_out
net.partitions[0].graph.nodes["Conv_153"]["hw"].coarse_out = pointwise_coarse_out//2
net.partitions[0].graph.nodes["Conv_161"]["hw"].coarse_out = pointwise_coarse_out
...
non_dsp_layers = [ "Conv_61", "Conv_69", ]
