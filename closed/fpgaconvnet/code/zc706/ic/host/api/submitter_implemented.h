...
#ifndef API_SUBMITTER_IMPLEMENTED_H_
#define API_SUBMITTER_IMPLEMENTED_H_
...
#define TH_VENDOR_NAME_STRING PLATFORM_NAME

#if BENCHMARK_INDEX == 1
#define TH_MODEL_VERSION EE_MODEL_VERSION_VWW01
#define FEATUREMAP_IN_SIZE  (96*96*3)
#define FEATUREMAP_OUT_SIZE (2)
#elif BENCHMARK_INDEX == 2
#define TH_MODEL_VERSION EE_MODEL_VERSION_IC01
#define FEATUREMAP_IN_SIZE  (32*32*3)
#define FEATUREMAP_OUT_SIZE (10)
#elif BENCHMARK_INDEX == 3
#define TH_MODEL_VERSION EE_MODEL_VERSION_KWS01
#define FEATUREMAP_IN_SIZE  (49*10)
#define FEATUREMAP_OUT_SIZE (12)
#elif BENCHMARK_INDEX == 4
#define TH_MODEL_VERSION EE_MODEL_VERSION_AD01
#define FEATUREMAP_IN_SIZE  (640)
#define FEATUREMAP_OUT_SIZE (640)
#else
#error "Please set BENCHMARK_INDEX between 1 and 4"
#endif

#define MAX_DB_INPUT_SIZE (FEATUREMAP_IN_SIZE * 4)
