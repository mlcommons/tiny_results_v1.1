...
coarse_out_base = 8
net.partitions[0].graph.nodes["Conv_21"]["hw"].coarse_out = 4
...
net.partitions[0].graph.nodes["Conv_43"]["hw"].coarse_out = 4*coarse_out_base
...
net.partitions[0].graph.nodes["Conv_57"]["hw"].coarse_out = 4*coarse_out_base
